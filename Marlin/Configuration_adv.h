...
//Raven using the chamber settings for the CONTROLLER FAN so we can control it based on temperature.
  ...
  #define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE      1   // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve; 3=similar to 1 but fan is always on.
      ...
      #define CHAMBER_FAN_BASE  8   // Base chamber fan PWM (0-255); turns on when chamber temperature is above the target
      #define CHAMBER_FAN_FACTOR 8   // PWM increase per °C above target
...
#define CHAMBER_AUTO_FAN_PIN PB4
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
// Raven FIXME post 230711. We're probing a high left edge by default, I think. IT's ignoring this! M422 works, though.
#define Z_STEPPER_ALIGN_XY { { 46, 148 }, { 206,  148 } }
  ...
  #define Z_STEPPER_ALIGN_ACC        0.04 // 0.04 is about our level of repeatability as of 230708. Stop iterating early if the accuracy is better than this
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER+48.6, Y_CENTER-26.8 }
  #endif
#endif
...
//#define SET_PROGRESS_MANUALLY
  ...
  #if BOTH(M73_REPORT, ENABLED(SDSUPPORT))
 ...
 */
// TEST pause and filament change
#define ADVANCED_PAUSE_FEATURE
  ...
  // Raven TEST 230715
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     240  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  // Raven TEST 230715
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   240  // (mm/s) Load filament feedrate. This can be pretty fast.
 ...
 */
   ...
   */
  // Raven TEST post-230712. complains about 640 for x, 384, 640 (for Y).
   #define TMC_HOME_PHASE { 384, 128, 128 }
