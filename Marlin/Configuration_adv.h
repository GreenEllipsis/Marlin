...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            0 // default 2  // (mm) Initial retract.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH          0 // default 50  // (mm) Length to extrude after loading.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH         0 // default 8  // (mm) An unretract is done, then this length is purged.
